--The following 2 lines lines have to be executed individually first by uncommenting or highlighting the command.
--use master;
--create database BankDB;
--Now BankDB is created!! Comment till this line and Click on Execute to add the tables to it... 
